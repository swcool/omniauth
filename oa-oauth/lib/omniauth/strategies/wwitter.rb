...
module OmniAuth
  module Strategies
    ...
    # Usage:
    #
    #    use OmniAuth::Strategies::Wwitter, 'consumerkey', 'consumersecret'
    #
    class Wwitter < OmniAuth::Strategies::OAuth
      ...
      def initialize(app, consumer_key = nil, consumer_secret = nil, options = {}, &block)
        ...
        super(app, :wwitter, consumer_key, consumer_secret, client_options, options)
      end
      ...
      def user_info
...

        {
          ...
          'urls' => {
            ...
            'Wwitter' => 'http://twitter.com/' + user_hash['screen_name']
          }
        }
      end
